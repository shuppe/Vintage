...
class EquipeTableMap extends TableMap
{
     ...
     */
    const COL_COULEUR = 'Equipe.couleur';

    /**
     * the column name for the abbrev field
     */
    const COL_ABBREV = 'Equipe.abbrev';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Nom', 'Couleur', 'Abbrev', ),
        self::TYPE_CAMELNAME     => array('id', 'nom', 'couleur', 'abbrev', ),
        self::TYPE_COLNAME       => array(EquipeTableMap::COL_ID, EquipeTableMap::COL_NOM, EquipeTableMap::COL_COULEUR, EquipeTableMap::COL_ABBREV, ),
        self::TYPE_FIELDNAME     => array('id', 'nom', 'couleur', 'abbrev', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Nom' => 1, 'Couleur' => 2, 'Abbrev' => 3, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'nom' => 1, 'couleur' => 2, 'abbrev' => 3, ),
        self::TYPE_COLNAME       => array(EquipeTableMap::COL_ID => 0, EquipeTableMap::COL_NOM => 1, EquipeTableMap::COL_COULEUR => 2, EquipeTableMap::COL_ABBREV => 3, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'nom' => 1, 'couleur' => 2, 'abbrev' => 3, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, )
    );
    ...
    public function initialize()
    {
        ...
        $this->addColumn('couleur', 'Couleur', 'VARCHAR', true, 50, null);
        $this->addColumn('abbrev', 'Abbrev', 'VARCHAR', true, 3, null);
    } // initialize()
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(EquipeTableMap::COL_COULEUR);
            $criteria->addSelectColumn(EquipeTableMap::COL_ABBREV);
        } else {
