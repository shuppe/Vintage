...
abstract class Joueur implements ActiveRecordInterface
{
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : JoueurTableMap::translateFieldName('Numero', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 7; // 7 = JoueurTableMap::NUM_HYDRATE_COLUMNS.
